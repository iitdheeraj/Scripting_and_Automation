...
HD_PWD='/home/vlsidesign2/Work/IC_Design/Assignment4/Assignment/Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Priority_Encoder8_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Priority_Encoder8_3.tcl
