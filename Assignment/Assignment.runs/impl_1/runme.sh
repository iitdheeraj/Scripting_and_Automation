...
HD_PWD='/home/vlsidesign2/Work/IC_Design/Assignment4/Assignment/Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Priority_Encoder8_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Priority_Encoder8_3.tcl -notrace
